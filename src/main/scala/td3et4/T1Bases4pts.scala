...
object Bases4pts extends App {
  ...
  Functions.getFirst10IntAndPowForEach()
  ...
  val tupleInt: (Int, Int) = Functions.firstTwo(seqInt)
  println(tupleInt)
  val tupleStr: (String, String) = Functions.firstTwo(Seq("hello", "world", "Scala"))
  println(tupleStr)
  val tupleDouble: (Double, Double) = Functions.firstTwo(Seq(3.14, 2.71, 1.41, 1.61))
  println(tupleDouble)
  ...
  val sandwich: (Int, Seq[Int], Int) = Functions.createSandwich(seqInt)
  println(sandwich)
}
